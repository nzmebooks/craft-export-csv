...
return [
    ...
    'section-exclude-related-handle-label' => 'Exclude related entries',
    'section-exclude-related-handle-instructions' => 'If selected, we\'ll exclude entries related to this section.',
    'field-exclude-related-handle-label' => 'Field to match entries to exclude',
    'field-exclude-related-handle-instructions' => 'If excluding related entries, choose the field handle to use when comparing sections. If this field matches between the two sections, the entry will be excluded.',
